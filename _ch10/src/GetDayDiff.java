...
public class GetDayDiff {
	...
	public static void main(String[] args) {
		System.out.println(getDayDiff("20100103", "20100101"));
		System.out.println(getDayDiff("20100103", "20100106"));
		System.out.println(getDayDiff("20100103", "201001"));
